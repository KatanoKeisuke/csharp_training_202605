...
using katano.Applications.Services.Impls;
using katano.Infrastructures.Adapters;
using katano.Infrastructures.Context;
using katano.Infrastructures.Repositories;
using katano.Presentations.Controllers;
using katano.Presentations.ViewModels;
namespace katano.Presentations.Extensions;
/// <summary>
/// 依存定義および依存性注入クラス
/// </summary>
